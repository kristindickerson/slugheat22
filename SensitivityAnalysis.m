...
%%  Last edit:
%       09/07/2023 by Kristin Dickerson, UCSC (kdickerson97@gmail.com)
%%% ======================================================================
...
if kDistribution == 1 || kDistribution == 2
    ...
    for i=SensorsToUse
        ...
        xlabel(axes_SA_TCvDepth, '\bfThermal Conductivity (W/m ^oC)', ...
...
% ===========================
    ...
    xlabel(axes_SA_TempvCTR,'\bfTemperature ( ^oC)', ...
        'verticalalignment','bottom', 'FontSize',18, 'Color',[0.00,0.45,0.74])
    ylabel(axes_SA_TempvCTR,'\bfCumulative Thermal Resistance (m^2 ^oC/W)', ...
        'verticalalignment','bottom', 'FontSize',18, 'Color',[0.00,0.45,0.74])
...
if Q < 0.1
    disp("Q < 0.1, therefore goodness of fit for Bullard plot is NOT believable !")
end
% =================================================================
...
%% KD TESTING
%% Plot scatter
scattercompare = plot(app.axes_sensscatter,AllHFUncertainty_perc,Iterations,'-o', ...
...
%% Plot histogram
histcompare = histogram(app.axes_senshist, AllHeatFlows, 'BinWidth', 0.5,'Tag', ...
