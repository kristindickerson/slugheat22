...
% ====================================== %
 ...
 for i = SensorsToUse
     ...
     n=n+1;
      ...
      % --------------------------------------------------
        xlabel(axes_TempvTime, 'Shifted Time (s)','fontsize',16,'verticalalignment','top')
  ...
  for i = SensorsToUse
     ...
     n=n+1;
      ...
      % --------------------------------------------------
        ...
        ylabel(axes_TempvTau, 'Temperature relative to bottom water ( ^oC)','fontsize',16,'verticalalignment','bottom')
